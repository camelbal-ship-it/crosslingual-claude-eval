...
The ILR scale has been used to evaluate machine translation output quality (Langdon, 2002) and, more recently, to calibrate language learning materials. To our knowledge, no published study has applied ILR-level annotations to LLM-generated outputs as a primary evaluation methodology. This paper constitutes the first systematic application of ILR descriptor language to LLM output analysis.
