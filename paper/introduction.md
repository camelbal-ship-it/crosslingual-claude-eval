...
2. **A citable prompt battery** of 12 semantically equivalent prompt clusters across six languages, annotated with ILR complexity levels, calibrated rationale, linguistic feature targets, and researcher hypotheses, made publicly available at [github.com/camelbal-ship-it/crosslingual-claude-eval](https://github.com/camelbal-ship-it/crosslingual-claude-eval).
