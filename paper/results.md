...
However, structural and sequencing differences revealed modest language-specific variation. Romanian responses opened with a section titled "Immediately after death" (*Imediat după deces*) emphasizing community announcement — notifying friends, neighbors, and former colleagues — reflecting the Romanian cultural norm of death as a collective community event. German responses opened directly with personal memory preservation, consistent with a more privatized grief culture.
...
5. **Cultural calibration defaults to culturally neutralized framing**: Claude renders responses in the target language without invoking culture-specific rituals, institutions, or discourse conventions — producing outputs that read as translations of English-language templates rather than natively calibrated responses. Structural sequencing and discourse closings show modest language-specific variation, but the absence of culture-specific content (Romanian: parastas, pomană, coliva; German: secular memorial institutions) represents a calibration gap that framing differences alone do not compensate for.
